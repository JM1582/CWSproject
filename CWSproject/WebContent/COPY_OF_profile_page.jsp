...
<!-- banner -->
<div class = "green1">
<h1 ><font face = Arial size = "5" color = "white" ><p align="center">Collaborative Workflow Solutions</p></font></h1>
</div>
...
<p style=font-size:22px;><strong>&emsp;&emsp;Location: <%=careProvider.getFacility() %></strong></p></row>
